package com.minicursojava.rocketseat.todolist.filter;
...
import com.minicursojava.rocketseat.todolist.user.repository.IUserRepository;
...
public class FilterTaskAuth extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    if (servletPath.startsWith("/task")) {
      ...
      var authBytes = Base64.getDecoder().decode(authEncoded);
